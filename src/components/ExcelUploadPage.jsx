      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-center h-[70vh]">
          <div className="bg-white dark:bg-white/5 p-8 rounded-2xl text-center max-w-md w-full shadow-lg">
            <h1 className="font-bold mb-6 text-2xl text-red-600">Upload Excel File

          </h1>
            
            <div className={`border-2 border-dashed rounded-lg p-8 mb-6 transition-colors ${isDragging ? 'border-company-accent bg-blue/10' : 'border-gray-300 hover:border-company-accent'}`} onDrop={handleDrop} onDragOver={handleDragOver} onDragLeave={handleDragLeave}>
            ...
            {selectedFile && <div className="text-left p-4 bg-blue/10 rounded-lg">
